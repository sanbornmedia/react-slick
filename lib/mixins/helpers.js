...
var helpers = {
  initialize: function initialize(props) {
    ...
    if (!props.vertical) {
      ...
      slideWidth = (0, _trackHelper.round)((this.getWidth(_reactDom2.default.findDOMNode(this)) - centerPaddingAdj) / props.slidesToShow);
    } else {
      slideWidth = (0, _trackHelper.round)(this.getWidth(_reactDom2.default.findDOMNode(this)));
    }
